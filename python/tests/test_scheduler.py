...
import sonicetl
from sonicetl.scheduler import Scheduler, TaskHook, TaskState
...
def test_etl_scheduler_run() -> None:
    res = sonicetl.run_pipelines_scheduled(_example_yaml(), workers=10, retries=2, poll_ms=5)
